            ...
            <header className="bg-pure_black md:sticky top-0 z-10">
                <div className="flex xl:p-6 md:p-3 flex-row items-center">
                    ...
                    <a href="https://github.com/SeanEvanss/react_portfolio_site"
                        className="inline-flex items-center bg-custom_gray border-0 py-1 px-3 focus:outline-none hover:bg-custom_beige rounded text-base mb-4 md:mb-0 hover:text-white mr-5">
